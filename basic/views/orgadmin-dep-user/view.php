...
$this->title = $model->department_user_id;
    ...
    <div id="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- content -->
                <div class="department-user-view">

                    <h1><?= Html::encode($this->title) ?></h1>

                    <p>
                        <?= Html::a('更新', ['update', 'id' => $model->department_user_id], ['class' => 'btn btn-primary']) ?>
                        <?= Html::a('删除', ['delete', 'id' => $model->department_user_id], [
