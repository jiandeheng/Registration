...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="<?php echo yii\helpers\Url::to(['superadmin-academy/index']) ?>"><i class="fa fa-desktop"></i> 学院管理</a>
            </li>
            <li>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="panel panel-primary text-center no-boder bg-color-green">
                    ...
                    <div class="panel-footer back-footer-green">
                        <a href="<?php echo yii\helpers\Url::to(['superadmin-academy/index']) ?>" class="enter">进入</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="panel panel-primary text-center no-boder bg-color-blue">
                    ...
                    <div class="panel-footer back-footer-blue">
                       <a href="<?php echo yii\helpers\Url::to(['superadmin-org/index']) ?>" class="enter">进入</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="panel panel-primary text-center no-boder bg-color-red">
                    ...
                    <div class="panel-footer back-footer-red">
                        <a href="<?php echo yii\helpers\Url::to(['superadmin-org-user/index']) ?>" class="enter">进入</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="panel panel-primary text-center no-boder bg-color-brown">
                    ...
                    <div class="panel-footer back-footer-brown">
                        <a href="<?php echo yii\helpers\Url::to(['superadmin-userinfo/index']) ?>" class="enter">进入</a>
                    </div>
                </div>
            </div>
        </div>
