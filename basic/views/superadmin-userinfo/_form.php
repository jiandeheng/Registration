...
<div class="user-form">
    ...
    <?= $form->field($model, 'user_organization_id')->dropDownList($organization, ['onchange' => '$.post("'.yii::$app->urlManager->createUrl('register/depopt').'&organizationId="+$(this).val(), function(data){
